...
from .backdoor_dataset import CIFAR10Mem, CIFAR10Pair, BadEncoderTestBackdoor, ReferenceImg, BadEncoderTestBackdoor_c_label
...
def get_downstream_svhn_edit_backdoor(args):
    training_file_name = 'train.npz'
    testing_file_name = 'test.npz'
...
def get_downstream_svhn_patch(args):
    training_file_name = 'train.npz'
    testing_file_name = 'test.npz'
